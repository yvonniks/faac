...
#define _MXU3_WORD(enc) ".word " #enc "\n\t"
static inline mxu3_v16i32 MXU3_LOAD(const void *p) {
    mxu3_v16i32 r;
    __asm__ __volatile__ ("move $t0, %0\n\t" _MXU3_WORD(0x71000813) _MXU3_WORD(0x71000853) _MXU3_WORD(0x71000893) _MXU3_WORD(0x710008D3) "move $t0, %1\n\t" _MXU3_WORD(0x71000057) _MXU3_WORD(0x71000097) _MXU3_WORD(0x710000D7) _MXU3_WORD(0x71000117) : : "r"(p), "r"(&r) : "$t0", "memory");
    return r;
}
static inline void MXU3_STORE(void *p, mxu3_v16i32 v) {
    __asm__ __volatile__ ("move $t0, %0\n\t" _MXU3_WORD(0x71000813) _MXU3_WORD(0x71000853) _MXU3_WORD(0x71000893) _MXU3_WORD(0x710008D3) "move $t0, %1\n\t" _MXU3_WORD(0x71000057) _MXU3_WORD(0x71000097) _MXU3_WORD(0x710000D7) _MXU3_WORD(0x71000117) : : "r"(&v), "r"(p) : "$t0", "memory");
}

#define _MXU3_BINOP(ret, a, b, op) do { \
    mxu3_v16i32 _a=a, _b=b, _r; \
    __asm__ __volatile__ ("move $t0, %1\n\t" _MXU3_WORD(0x71000813) _MXU3_WORD(0x71000853) _MXU3_WORD(0x71000893) _MXU3_WORD(0x710008D3) "move $t0, %2\n\t" _MXU3_WORD(0x71000913) _MXU3_WORD(0x71000953) _MXU3_WORD(0x71000993) _MXU3_WORD(0x710009D3) _MXU3_WORD(op|0x000) _MXU3_WORD(op|0x040) _MXU3_WORD(op|0x080) _MXU3_WORD(op|0x0C0) "move $t0, %0\n\t" _MXU3_WORD(0x71000257) _MXU3_WORD(0x71000297) _MXU3_WORD(0x710002D7) _MXU3_WORD(0x71000317) : : "r"(&_r), "r"(&_a), "r"(&_b) : "$t0", "memory"); \
    ret = _r; \
} while(0)
...
#define _MXU3_UNIOP(ret, a, op) do { \
    mxu3_v16i32 _a=a, _r; \
    __asm__ __volatile__ ("move $t0, %1\n\t" _MXU3_WORD(0x71000813) _MXU3_WORD(0x71000853) _MXU3_WORD(0x71000893) _MXU3_WORD(0x710008D3) _MXU3_WORD(op|0x000) _MXU3_WORD(op|0x040) _MXU3_WORD(op|0x080) _MXU3_WORD(op|0x0C0) "move $t0, %0\n\t" _MXU3_WORD(0x71000257) _MXU3_WORD(0x71000297) _MXU3_WORD(0x710002D7) _MXU3_WORD(0x71000317) : : "r"(&_r), "r"(&_a) : "$t0", "memory"); \
    ret = _r; \
} while(0)

static inline mxu3_v16i32 mxu3_ftsiw(mxu3_v16i32 a) { mxu3_v16i32 r; _MXU3_UNIOP(r, a, 0x70e0002e); return r; }
