...
static __inline__ int mxu2_bnez16b(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) != 0; }
static __inline__ int mxu2_bnez8h(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) != 0; }
static __inline__ int mxu2_bnez4w(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) != 0; }
static __inline__ int mxu2_bnez2d(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) != 0; }
static __inline__ int mxu2_bnez1q(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) != 0; }
static __inline__ int mxu2_beqz16b(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) == 0; }
static __inline__ int mxu2_beqz8h(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) == 0; }
static __inline__ int mxu2_beqz4w(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) == 0; }
static __inline__ int mxu2_beqz2d(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) == 0; }
static __inline__ int mxu2_beqz1q(mxu2_v16i8 v) { union { mxu2_v16i8 v; uint32_t p[4]; } _u; _u.v = v; return (_u.p[0] | _u.p[1] | _u.p[2] | _u.p[3]) == 0; }
...
static __inline__ mxu2_v4i32 mxu2_mffpu_d(double val) {
    union { mxu2_v4i32 v; double d[2]; } _u; _u.d[0] = val; _u.d[1] = val; return _u.v;
}
...
static __inline__ mxu2_v16i8 mxu2_repx_b(mxu2_v16i8 v, int lane) {
    union { mxu2_v4i32 v; signed char val_arr[16]; } _u; _u.v = (mxu2_v4i32)v; signed char val = _u.val_arr[lane];
...
static __inline__ mxu2_v8i16 mxu2_repx_h(mxu2_v8i16 v, int lane) {
    union { mxu2_v4i32 v; short val_arr[16]; } _u; _u.v = (mxu2_v4i32)v; short val = _u.val_arr[lane];
    return (mxu2_v8i16){val,val,val,val,val,val,val,val};
}
static __inline__ mxu2_v4i32 mxu2_repx_w(mxu2_v4i32 v, int lane) {
    union { mxu2_v4i32 v; int val_arr[16]; } _u; _u.v = (mxu2_v4i32)v; int val = _u.val_arr[lane];
    return (mxu2_v4i32){val,val,val,val};
}
static __inline__ mxu2_v4i32 mxu2_repx_d(mxu2_v4i32 v, int lane) {
    union { mxu2_v4i32 v; long long val_arr[16]; } _u; _u.v = (mxu2_v4i32)v; long long val = _u.val_arr[lane];
